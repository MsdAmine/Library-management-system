      ...
      <header className="sticky top-0 z-40 w-full border-b border-slate-200/80 bg-white/90 backdrop-blur-xl transition-all shadow-xs">
        <div className="h-16 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3 flex-shrink-0">
            <NavLink 
              to="/" 
              className="group flex items-center gap-3 whitespace-nowrap flex-shrink-0 transition-transform duration-200 active:scale-95"
            >
              ...
              <div className="flex flex-col whitespace-nowrap">
                ...
                <span className="text-xs text-indigo-600 font-semibold tracking-wider block">MANAGEMENT SYSTEM</span>
              </div>
            </NavLink>
          </div>
            ...
            {navItems.map((item) => {
              ...
              return (
                <NavLink
                  key={item.path}
                  to={item.path}
                  className={`whitespace-nowrap flex items-center gap-2 px-3 py-2 text-sm font-medium rounded-lg transition-colors ${
                    isActive
                      ? 'text-indigo-600 bg-indigo-50 font-semibold border border-indigo-200/70 shadow-xs'
          ...
          <div className="hidden md:flex items-center gap-3 flex-shrink-0">
            ...
            <div className="flex items-center gap-2.5 pl-3 border-l border-slate-200">
              <div className="h-8 w-8 rounded-full bg-slate-100 border border-slate-200 flex items-center justify-center text-slate-600 shadow-xs font-medium flex-shrink-0">
                <UserIcon className="h-4 w-4" />
              </div>
              <span className="max-w-[180px] truncate text-sm text-slate-600 font-medium" title={user?.email}>
            ...
            <button
              ...
              className="group flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-slate-600 hover:text-rose-700 bg-white hover:bg-rose-50 rounded-xl border border-slate-200 hover:border-rose-200 transition-all duration-200 shadow-xs cursor-pointer flex-shrink-0"
